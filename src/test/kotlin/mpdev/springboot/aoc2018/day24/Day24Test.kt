...
class Day24Test {
    ...
    fun `Reads Input and sets up Immune System and Infections`() {
        ...
        assertThat(immuneSystem.antibodies.map { it.numOfUnits }).isEqualTo(listOf(17, 989))
        assertThat(immuneSystem.infection.map { it.numOfUnits }).isEqualTo(listOf(801, 4485))
    }
    ...
    fun `Calculates Damage Level and Selects Targets`() {
        ...
        immuneSystem.infection.forEach { println(it) }
        println("\nselect targets")
        var damage11 = immuneSystem.calcDamage(immuneSystem.infection[0], immuneSystem.antibodies[0])
        var damage12 = immuneSystem.calcDamage(immuneSystem.infection[0], immuneSystem.antibodies[1])
        var damage21 = immuneSystem.calcDamage(immuneSystem.infection[1], immuneSystem.antibodies[0])
        var damage22 = immuneSystem.calcDamage(immuneSystem.infection[1], immuneSystem.antibodies[1])
        ...
        damage11 = immuneSystem.calcDamage(immuneSystem.antibodies[0], immuneSystem.infection[0])
        damage12 = immuneSystem.calcDamage(immuneSystem.antibodies[0], immuneSystem.infection[1])
        damage21 = immuneSystem.calcDamage(immuneSystem.antibodies[1], immuneSystem.infection[0])
        damage22 = immuneSystem.calcDamage(immuneSystem.antibodies[1], immuneSystem.infection[1])
        ...
        assertThat(immuneSystem.antibodies[1].currentTarget).isEqualTo(0)
        assertThat(immuneSystem.infection[0].currentTarget).isEqualTo(0)
    ...
    fun `Simulates Battle`() {
        ...
        var count = 0
        var unitsLeft = -1
        while(immuneSystem.antibodies.count { it.numOfUnits > 0 } > 0 && immuneSystem.infection.count { it.numOfUnits > 0 } > 0) {
            ...
            immuneSystem.antibodies.forEach { println(it) }
            immuneSystem.infection.forEach { println(it) }
            unitsLeft = immuneSystem.antibodies.sumOf { it.numOfUnits } + immuneSystem.infection.sumOf { it.numOfUnits }
